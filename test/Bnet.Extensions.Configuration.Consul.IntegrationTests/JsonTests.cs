...
{
    [ClassDataSource<JsonApplication>]
    public required JsonApplication Application { get; init; }

    [Test]
    [Arguments("config/String", "Hello")]
    [Arguments("config/Integer", "13")]
    [Arguments("config/Array:0", "FirstValue")]
    [Arguments("config/Array:1", "SecondValue")]
...
public sealed class JsonApplication : ConsulApplication
{
    public const string Key = "appsettings.json";
